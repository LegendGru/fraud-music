module.exports = {
    ...
    async execute(client, message, args) {
        ...
        if (!args[0]) return message.channel.send(`${message.author}, Lütfen geçerli bir filtre ismi yazın. ${client.config.red} \n\`bassboost, 8D, nightcore\``);
        ...
        if (!filter) return message.channel.send(`${message.author}, Yazdığın isimde bir filtre bulamadım. ${client.config.red} \n\`bassboost, 8D, nightcore\``);
